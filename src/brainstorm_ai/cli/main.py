...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler(log_dir / "brainstorm.log"), logging.StreamHandler(sys.stdout)],
)
...
try:
    ...
    logger.info(
        "Module python-dotenv non installé, utilisation des variables d'environnement système uniquement"
    )
